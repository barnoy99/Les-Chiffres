...
var SENTENCES = [
  ...
  { id: 26, en: "The bill came to 76 euros.", fr: "L'addition est montée à soixante-seize euros.", context: "Restaurant" },
  { id: 27, en: "Two coffees, that's 5.40.", fr: "Deux cafés, ça fait cinq euros quarante.", context: "Café" },
  { id: 28, en: "It's three for five euros.", fr: "C'est cinq euros les trois.", context: "Shopping" },
  { id: 29, en: "Shipping costs an extra 4.90.", fr: "Il y a quatre euros quatre-vingt-dix de frais de port en plus.", context: "Online shopping" },
  { id: 30, en: "I got it half price, 29 euros.", fr: "Je l'ai eu à moitié prix, vingt-neuf euros.", context: "Sales" },

  // ── Time & schedules ────────────────────────────────────
  { id: 40, en: "The train leaves at 8:45.", fr: "Le train part à neuf heures moins le quart.", context: "Travel" },
  ...
  { id: 47, en: "Call me back around 6.", fr: "Rappelle-moi vers six heures.", context: "Phone" },
  ...
  { id: 83, en: "He finished in 3rd place.", fr: "Il a fini troisième.", context: "Ranking" },
